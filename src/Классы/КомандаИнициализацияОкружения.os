...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ОписательПодключения = ПолучитьДанныеПодключенияКИнфобазе(ПараметрыКоманды);

	ИнициализироватьБазуДанных(ПараметрыКоманды["--src"], ПараметрыКоманды["--dt"],
					ОписательПодключения,, 
					ПараметрыКоманды["--dev"], ПараметрыКоманды["--storage"], 
...
Процедура ИнициализироватьБазуДанных(Знач ПутьКSRC="", Знач ПутьКDT="", Знач ОписательПодключения,
										Знач КлючРазрешенияЗапуска = "", Знач РежимРазработчика = Ложь, 
...
Функция ПолучитьДанныеПодключенияКИнфобазе(ПараметрыКоманды)
	Рез = Новый Структура;
	Рез.Вставить("СтрокаПодключения", ПараметрыКоманды["--ibname"])
	Рез.Вставить("Пользователь", ПараметрыКоманды["--db-user"]);
	Рез.Вставить("Пароль", ПараметрыКоманды["--db-pwd"]);
	Рез.Вставить("ВерсияПлатформы", ПараметрыКоманды["--v8version"]);
	Возврат Рез;
КонецФункции