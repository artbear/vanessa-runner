...
Функция УправлениеКонфигуратором(Знач ПараметрыКоманды) Экспорт
	СтрокаПодключения = ПараметрыКоманды["--ibname"];
...
Функция ПолучитьКлючиПроверкиКонфигурации(Знач КоллекцияПроверок)
	...
	Кл- =ickClientOrdinaryApplication", ФлагПоУмолчанию);
